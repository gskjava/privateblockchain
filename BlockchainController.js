...
class BlockchainController {
    ...
    getBlockByHeight() {
        this.app.get("/blocks/height/:height", async (req, res) => {
            if(req.params.height) {
                ...
                if(block){
                    ...
                    return res.status(404).send("The Block Not Found !");
                }
            } else {
                return res.status(404).send("The Block Not Found! Review the Parameters!");
            }
        ...
        this.app.post("/submitstar", async (req, res) => {
            if(req.body.address && req.body.message && req.body.signature && req.body.star) {
                ...
                try {
                    ...
                    console.log("error happened 1");
                    return res.status(500).send(error);
                }
            } else {

                console.log("error happened check body");
                return res.status(500).send("Check the Body Parameter!");
            }
        });
    }
